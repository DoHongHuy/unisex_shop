                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title" style="    background-color: lightgrey;text-align: center;margin-right: inherit;margin-left: inherit;font-size: 63px;font-style: oblique;">MENU CAFE
                                </form>
                            </h4>

                        </div>
                        <%@include file="/cp/product/edit.jsp"%>
                    </div>
                </div>
            </div> <!-- content -->
            <!-- Footer Start -->
