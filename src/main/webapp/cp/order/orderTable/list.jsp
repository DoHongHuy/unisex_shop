                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title" style="background-color: lightgrey;text-align: center; margin-right: inherit;margin-left: inherit;">ORDER CAFE
                        ...
                        <%@include file="/cp/order/orderTable/order.jsp"%>
                    </div>
                </div>
            </div> <!-- content -->
            <!-- Footer Start -->
